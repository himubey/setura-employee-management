 ...
 *
 * Next.js strips the real message in production, which is what we want — a
 * database or authorization error must never surface a connection string or
 * an internal path to the browser.
 */
