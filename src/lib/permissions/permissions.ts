 ...
 *
 * Deliberately not a policy engine: no conditions, no inheritance, no
 * database-backed rules. A developer can read this file top to bottom and
 * know exactly who can do what. Row-level questions ("may this manager see
 * *this* employee?") belong in the service layer, where the row is in hand —
 * see `canAccessEmployee` in authorize.ts.
 */
