...
/**
 * Desktop sidebar. A Server Component — it receives the role and filters the
 * navigation on the server, so links the user cannot use are never sent to
 * the browser at all.
 *
 * Hiding a link is presentation, not security: every route and service still
