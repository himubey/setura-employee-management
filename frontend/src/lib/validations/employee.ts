...
/**
 * Employee validation — the frontend's own rules, used for forms and for
 * typing the list query.
 *
 * These are a convenience, never a guarantee: the FastAPI backend validates
 * independently and is the authority. CONTRACT: the enums and field names
 * below must be reconciled with Sakshi's Pydantic models.
 */
...
/** `YYYY-MM-DD` — the wire format for a calendar date. */
